									...
									<tbody>
										<?php while ($data_tagihan = $select_tagihan->fetch(PDO::FETCH_OBJ)) { ?>
											...
											<tr>
												...
												<td>
													<?php if ($data_tagihan->status == "Belum Dibayar"): ?>
														<a href="bayar.php?id=<?= base64_encode($data_tagihan->id_tagihan); ?>"
															class="btn btn-primary" data-position="top" data-delay="50"
															data-tooltip="Bayar">
															<i class="fa fa-credit-card white-text"></i>
														</a>
													<?php else: ?>
														<a onclick="print()" class="btn btn-warning" data-position="top"
															data-delay="50" data-tooltip="Print Struk Pembayaran">
