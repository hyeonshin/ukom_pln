					...
					<div class="row">
						<div class="card mb-4 p-0">
							...
							<div class="d-flex justify-content-end m-3">
								<!-- <a onclick="print()" class="btn btn-success" id="button"><i
											class="fa fa-print"></i>&ensp;Cetak Data</a> -->
								<a href="input.php" class="btn btn-primary"><i class="fa fa-plus"></i>&ensp;Add
									Pelanggan</a>
							</div>
							<div class="card-body">
										...
										<?php while ($data = $view->fetch(PDO::FETCH_OBJ)) { ?>
											...
											<tr>
												...
												<td>
													...
													<a href="detail.php?id=<?= base64_encode($data->id_pelanggan); ?>"
														class="btn btn-success" data-position="top" data-delay="50"
														data-tooltip="Lihat Tagihan">
