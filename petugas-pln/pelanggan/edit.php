		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">Edit Pelanggan Data Form</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="../index.php">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="./index.php">Pelanggan</a></li>
						<li class="breadcrumb-item active">Edit Pelanggan Data</li>
					</ol>
					<div class="row">
						<div class="container">
								...
								<div class="col-lg-7">
									<div class="card shadow-lg border-0 rounded-lg mt-5">
										<div class="card-header">
											<h3 class="text-center font-weight-light my-4">Edit Pelanggan Data</h3>
										</div>
										<div class="card-body">
											<form class="form-horizontal row-fluid" action="" method="post">
												...
												<div class="row mb-3">
													<div class="row g-2">
														<div class="col-md">
															<div class="form-floating">
																<input type="text" name="nama_pelanggan"
																	id="nama_pelanggan" class="form-control"
														...
														<div class="col-md">
															<div class="form-floating">
																<input type="number" name="nometer" id="nometer"
																	value="<?= $data->nometer ?>" class="form-control"
																	required="">
															...
															<div class="form-floating">
																<select class="form-select" name="id_tarif" required="">
																	...
																	<?php while ($data_tarif = $view_tarif->fetch(PDO::FETCH_OBJ)) {
																		...
																		?>
																		<option value="<?= $data_tarif->id_tarif ?>"
																			<?= $selected ?>>
																			<?= $data_tarif->id_tarif ?> |
																			<?= $data_tarif->daya ?> VA
																		</option>
													...
													<div class="row g-1">
														<div class="form-floating">
															<textarea class="form-control" name="alamat" id="alamat"
																style="height: 80px" required=""><?= $data->alamat ?></textarea>
												...
												<div class="mt-4 mb-0">
													<div class="d-grid"><button type="submit" name="kirim"
															...
															<i class="fa fa-pencil icon-form"></i>&ensp;Edit data
														</button>
													</div>
												</div>
											</form>
