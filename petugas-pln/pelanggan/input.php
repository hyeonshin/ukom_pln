							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" action="" method="post">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="nama_pelanggan" id="nama_pelanggan" class="span8" required="">
											</div>
										...
										<div class="control-group">
											...
											<div class="controls ">
												<input type="number" name="nometer" id="nometer" class="span8" required="">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<option value="<?= $data->id_tarif ?>"><?= $data->id_tarif ?> | <?= $data->daya ?> VA</option>
												<?php } ?>
												</select>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<select name="id_kota" required="">
													...
													<option value="<?= $data->id_kota ?>"><?= $data->id_kota ?> - <?= $data->nama_kota ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea name="alamat" id="alamat" class="span8" required=""></textarea>
											</div>
										</div>
