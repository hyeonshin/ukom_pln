				...
				<div class="span3">
					<div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="index.php"><i class="menu-icon fa fa-building"></i>Kota</a>
                                </li>
					...
					<div class="content">
						<div class="module">
							<div class="module-head clearfix">
                                    <div class="pull-left">
                                        <h3>Table Data Kota</h3>
                                    </div>
                                    <div class="pull-right">
                                        <a href="input.php" class="btn btn-primary"><i class="fa fa-plus"></i>&ensp;Add Kota</a>
                                    </div>
                                </div>
							<div class="module-body table">
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tr>
										...
										<td><?php echo $data->ppju; ?>%</td>
										<td>
											
											<center><a href="edit.php?id=<?= base64_encode($data->id_kota); ?>" class="btn btn-info" data-position="top" data-delay="50" data-tooltip="Edit Data">
