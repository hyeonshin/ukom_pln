...
$get_code = $lib->code_generator_kota();
...
if (isset($_POST['kirim'])) {
	...
	$nama_kota = "";
	$ppju = "";
	$simpan = $lib->input_kota($id_kota, $nama_kota, $ppju);
	if ($simpan == "SUCCESS") {
		echo "
		<script>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Input Data Kota</h3>
							</div>
							<div class="module-body">


									<form class="form-horizontal row-fluid" action="" method="post">
										<input type="hidden" name="id_kota" value="<?= $get_code; ?>">
										<div class="control-group">
											<label class="controls" for="basicinput">Nama Kota</label>
											<div class="controls">
												<input type="text" name="nama_kota" id="nama_kota" class="span8" required="" placeholder="Example : Jakarta">
											</div>

										</div>
										
										<div class="control-group">
											<label class="controls" for="basicinput">PPJU</label>
											<div class="controls">
												<input type="number" name="ppju" id="ppju" class="span8" required="" placeholder="Example : 2">
