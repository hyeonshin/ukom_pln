								...
								<table id="datatablesSimple">
									...
									<tbody>
										<?php while ($data = $view->fetch(PDO::FETCH_OBJ)) {
											...
											<tr>
												<td>
													<?php echo $data->id_tarif; ?>
												</td>
												<td>
													<?php echo $daya; ?> VA
												</td>
												<td>
													<?php echo $tarif_per_kwh; ?>/KWH
												</td>
												<td>
													<?php echo $data->ppn; ?>%
												</td>
												<td>
													<?php echo $denda; ?>/Bulan
												</td>
												<td>
													<a href="edit.php?id=<?= base64_encode($data->id_tarif); ?>"
														class="btn btn-info" data-position="top" data-delay="50"
														data-tooltip="Edit Data">
														<i class="fa fa-edit white-text"></i>
													</a>
													<a href="delete.php?id=<?= base64_encode($data->id_tarif); ?>"
														class="btn btn-danger" data-position="top" data-delay="50"
