					...
					<div class="content">
						<div class="module">
							<div class="module-head clearfix">
                                    ...
                                    <div class="pull-right">
                                        <a href="input.php" class="btn btn-primary"><i class="fa fa-plus"></i>&ensp;Add Tarif</a>
                                    </div>
                                </div>
						...
						<?php while ($data = $view->fetch(PDO::FETCH_OBJ)) { 
							...
							<tr>
								...
								<td>
									<a href="edit.php?id=<?= base64_encode($data->id_tarif); ?>" class="btn btn-info" data-position="top" data-delay="50" data-tooltip="Edit Data">
										<i class="fa fa-edit white-text"></i>
									</a>
									<a href="delete.php?id=<?= base64_encode($data->id_tarif); ?>" class="btn btn-danger" data-position="top" data-delay="50" data-tooltip="Hapus Data">
