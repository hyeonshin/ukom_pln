							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" action="" method="post">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="daya" id="daya" class="span8" required="" placeholder="Example : 450" value="<?= $data->daya; ?>">
										...
										<div class="control-group">
											...
											<div class="controls ">
												...
												<input type="number" name="tarif_per_kwh" id="tarif_per_kwh" class="span8" required="" placeholder="Example : 2500" value="<?= $data->tarif_per_kwh ?>">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="number" name="ppn" id="ppn" class="span8" required="" placeholder="Example : 2" value="<?= $data->ppn ?>">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="number" name="denda" id="denda" class="span8" required="" placeholder="Example : 2000" value="<?= $data->denda ?>">
