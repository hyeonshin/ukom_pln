...
if (isset($_POST['kirim'])) {
	$id_user = "";
	$password = "";
	$lupa = $lib->forget_password($id_user, $password);
	if ($lupa == "SUCCESS") {
		echo "
		<script>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">Reset Password User Form</h1>
								...
								<div class="col-lg-7">
									<div class="card shadow-lg border-0 rounded-lg mt-5">
										<div class="card-header">
											<h3 class="text-center font-weight-light my-4">Reset Password User</h3>
										</div>
										<div class="card-body">
											<form class="form-horizontal row-fluid" action="" method="post">
												<input type="hidden" name="id_user" value="<?= $data->id_user; ?>">
												<div class="text-bg-warning p-3"><strong>Perhatian!</strong> Form ini
													digunakan hanya untuk keadaan darurat!</div>
												<div class="row mb-3">
													<div class="row g-2">
														<div class="col-md">
												...
												<div class="mt-4 mb-0">
													<div class="d-grid"><button type="submit" name="kirim"
															...
															<i class="fa fa-refresh icon-form"></i>&ensp;Change Password
														</button>
													</div>
												</div>
											</form>
