                    ...
                    <div class="content">
                        <div class="btn-controls">
                            <div class="btn-box-row row-fluid">
                                ...
                                <div class="btn-box big span4"><i class="fa fa-user"></i><b>
                                        <?= $get_data['nama_user']; ?>
                                    </b>
                                    <p class="text-muted">
                                        <?= $get_data['level']; ?>
                            ...
                            <div class="btn-box-row row-fluid">
                                <div class="span8">
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <a href="user/index.php" class="btn-box small span12"><i
                                                    class="icon-group"></i><b>
                                                    <?= $jumlah_petugas_pln ?>
                                                </b><b><small>Petugas PLN</small></b>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <a href="user/index.php" class="btn-box small span12"><i
                                                    class="icon-group"></i><b>
                                                    <?= $jumlah_petugas_pembayaran ?>
                                                </b><b><small>Petugas Pembayaran</small></b>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <ul class="widget widget-usage unstyled span4">
                                    <li>
                                        <p>
                                            <strong>Petugas PLN</strong> <span class="pull-right small muted">
                                                <?= $grafik_pln; ?>%
                                            </span>
                                        </p>
                                    ...
                                    <li>
                                        <p>
                                            <strong>Petugas Pembayaran</strong> <span class="pull-right small muted">
                                                <?= $grafik_pembayaran; ?>%
                                            </span>
                                        </p>
                                        <div class="progress tight">
